      ...
      <div className="flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        <div className="flex max-lg:ml-auto space-x-4">
          <NavLink
            to="/pokemon/add"
            className={({ isActive }) =>
              `px-4 py-2 text-sm rounded-full font-bold  border-2 ${
                isActive
                  ? "border-[#007bff] bg-[#007bff] text-white"
                  : "text-gray-500 bg-transparent"
              } border-2 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff] hover:border-[#007bff]`
            }>
            Add Pokemon
          </NavLink>
